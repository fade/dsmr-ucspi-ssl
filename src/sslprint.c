...
/* Common TLS/SSL connection variables */
  ...
  buffer_puts(buffer_1,"\nSSL_TLS_SNI=");
  x = env_get("SSL_TLS_SNI_1");
  buffer_puts(buffer_1,x ? x : "unset");

/* TLS Server X.509 cert values */
...
// Cert SAN values
  ...
  x = env_get("SSL_SERVER_SAN_Email_0");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_SERVER_SAN_Email_1=");
  x = env_get("SSL_SERVER_SAN_Email_1");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_SERVER_SAN_DNS_0=");
  x = env_get("SSL_SERVER_SAN_DNS_0");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_SERVER_SAN_DNS_1=");
  x = env_get("SSL_SERVER_SAN_DNS_1");
  buffer_puts(buffer_1,x ? x : "unset");
...
// Cert SAN values
  ...
  x = env_get("SSL_CLIENT_SAN_Email_0");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_CLIENT_SAN_Email_1=");
  x = env_get("SSL_CLIENT_SAN_Email_1");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_CLIENT_SAN_DNS_0=");
  x = env_get("SSL_CLIENT_SAN_DNS_0");
  buffer_puts(buffer_1,x ? x : "unset");

  buffer_puts(buffer_1,"\nSSL_CLIENT_SAN_DNS_1=");
  x = env_get("SSL_CLIENT_SAN_DNS_1");
  buffer_puts(buffer_1,x ? x : "unset");
